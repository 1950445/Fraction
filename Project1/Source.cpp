...
class Human
{
	static const int LAST_NAME_WIDHT = 12;
	static const int FIRST_NAME_WIDHT = 12;
	static const int AGE_WIDHT = 5;
	static int count = 0;
protected:
	string last_name;
	string first_name;
...
public:
	...
	virtual std::ofstream print(std::ofstream& ofs)const
	{
		ofs.width(12);
		ofs << std::left;
		return ofs << last_name << " " << first_name << " " << age;
		return ofs
	}
};
...
std::oftream& operator << (std::ostream& os, const Human& obj)
{
	 obj.print(ofs);
	 return ogs;
}
...
void main()
{
	...
	Human* diaz = new Teacher("Dizz""Ricardo"55, "Weapons distribution", 25);
